...
elif logs: st.sidebar.success(f"🟢 Active Last: {logs[0].timestamp}")
else: st.sidebar.success("🟢 Active")
...
if not tenders:
    st.error("No REAL tenders found even after live Jina fetch. Check Actions logs.")
    st.stop()
